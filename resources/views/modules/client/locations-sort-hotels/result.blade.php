...
@section('content')
    ...
    <div class="content">
        ...
        <section class="parallax-section single-par" data-scrollax-parent="true">
            <div class="bg par-elem " data-bg="{{ asset('image/locations/' . $city->image) }}"
                data-scrollax="properties: { translateY: '30%' }"></div>
            <div class="overlay"></div>
            <div class="container">
                <div class="section-title center-align big-title">
                    <div class="section-title-separator"><span></span></div>
                    <h2><span>{{ $city->name }}</span></h2>
        ...
        <div class="breadcrumbs-fs fl-wrap">
            <div class="container">
                <div class="breadcrumbs fl-wrap"><a href="#">Home</a><a href="#">Listing
                    </a><span>{{ $city->name }}</span></div>
            </div>
        </div>
        <!--  section-->
                            ...
                            <div class="filter-sidebar fl-wrap lws_mobile">
                                ...
                                <div class="col-list-search-input-item fl-wrap">
                                    <div class="quantity-item">
                                        <label>Rooms</label>
                                        <div class="quantity">
                                            <input name="no_rooms" type="number" min="1" max="3"
                                                step="1" value="1">
                                        </div>
                                    </div>
                                    <div class="quantity-item">
                                        <label>Adults</label>
                                        <div class="quantity">
                                            <input name="adults" type="number" min="1" max="5"
                                                step="1" value="1">
                                        </div>
                                    </div>
                                    <div class="quantity-item">
                                        ...
                                        <div class="quantity">
                                            <input name="kids" type="number" min="0" max="3"
                                                step="1" value="0">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="list-main-wrap fl-wrap card-listing">
                                ...
                                <div class="list-main-wrap-opt fl-wrap">
                                    <div class="list-main-wrap-title fl-wrap">
                                        <h2>Results For : <span class="name_city">{{ $city->name }} </span></h2>
                                    </div>
                                    <!-- price-opt-->
                                    <div class="price-opt">
                                            ...
                                            <article class="geodir-category-listing fl-wrap">
                                                ...
                                                <div class="geodir-category-content fl-wrap">
                                                    ...
                                                    <div class="geodir-category-footer fl-wrap">
                                                        <div class="geodir-category-price">Awg/Night <span>$ 320</span>
                                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let dates = dateIn + '-' + dateOut;
            $('input[name="dates"]').val(dates);
            $('input[name="no_rooms"]').val(room);

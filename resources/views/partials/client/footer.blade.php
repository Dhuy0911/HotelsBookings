                            ...
                            <div class="subcribe-form">
                                <form id="subscribe">
                                    ...
                                    <button type="submit" id="subscribe-button" class="subscribe-button"><i
                                            class="fas fa-rss-square"></i> Subscribe</button>
    ...
    <div class="footer-inner">
        <div class="container">
                        ...
                        <div class="footer-carousel-wrap fl-wrap">
                            <div class="footer-carousel fl-wrap">
                                ...
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('client/images/partners/1.png') }}"
                                            alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                                <!--footer-carousel-item-->
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('client/images/partners/2.png') }}"
                                            alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                                <!--footer-carousel-item-->
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('client/images/partners/3.png') }}"
                                            alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                                <!--footer-carousel-item-->
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('client/images/partners/4.png') }}"
                                            alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                                <!--footer-carousel-item-->
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('client/images/partners/5.png') }}"
                                            alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                                <!--footer-carousel-item-->
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('client/images/partners/6.png') }}"
                                            alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                            </div>
                    ...
                    <div class="footer-widget fl-wrap">
                        ...
                        <div class="footer-contacts-widget fl-wrap">
                            ...
                            <ul class="footer-contacts fl-wrap">
                                ...
                                <li> <span><i class="fal fa-map-marker-alt"></i> Adress :</span><a href="#"
                            ...
                            <div class="footer-social">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#" target="_blank"><i class="fab fa-vk"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <ul>
                                <li class="clearfix">
                                    <a href="#" class="widget-posts-img"><img
                                            src="{{ asset('client/images/all/1.jpg') }}" class="respimg"
                                            alt=""></a>
                                ...
                                <li class="clearfix">
                                    <a href="#" class="widget-posts-img"><img
                                            src="{{ asset('client/images/all/2.jpg') }}" class="respimg"
                                            alt=""></a>
                                    <div class="widget-posts-descr">
                                ...
                                <li class="clearfix">
                                    <a href="#" class="widget-posts-img"><img
                                            src="{{ asset('client/images/all/3.jpg') }}" class="respimg"
                                            alt=""></a>
                                    <div class="widget-posts-descr">
            ...
            <div class="footer-widget">
                <div class="row">
                    <div class="col-md-4"><a class="contact-btn color-bg" href="contacts.html">Get In
                            Touch<i class="fal fa-envelope"></i></a></div>
                    <div class="col-md-8">
                        <div class="customer-support-widget fl-wrap">
                            <h4>Customer support : </h4>
                            <a href="tel:+19012300888" class="cs-mumber">+1(901)2300888</a>
                            <a href="tel:+19012300888" class="cs-mumber-button color2-bg">Call Now <i

            ...
            <div class="dasboard-wrap fl-wrap">
                ...
                <div class="dashboard-content fl-wrap">
                    <div class="dashboard-list-box fl-wrap">
                        ...
                        @if ($hotels->isEmpty())
                            <div>
                                <h1 style="font-size: 16px"> You must create hotels first</h1>
                            </div>
                        @else
                            <div class="dashboard-list">
                                ...
                                <form action="{{ route('hotels.rooms.store') }}" enctype="multipart/form-data"
                                    method="post">
                                    @csrf
                                    <div class="profile-edit-container addroomform">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="quantity">
                                                                    <input step="1" min="0" type="number"
                                        ...
                                        <button type="submit" style="border: none"
                                            class="add-button save-room-btn color-bg">
                                            Save</button>
                                    </div>
                                                ...
                                                <div class="rooms-item fl-wrap">
                                                        ...
                                                        {{-- @foreach ($room_image as $image)
                                                            @if ($item->id == $image->rooms_id)
                                                                ...
                                                                <div class="dynamic-gal more-photos-button"
                                                                    data-dynamicPath="[{'src': '{{ asset('image/rooms/' . $image->image) }}'}]">
                                                                    View Gallery <span>
                                                                        photos</span>
                                                    ...
                                                    <div class="rooms-details">
                                                        ...
                                                        <a style="font-size: 16px"
                                                            href="{{ route('hotels.roomlist.edit', ['id' => $item->id]) }}"><i
                                                                class="fa-solid fa-pen-to-square"></i></a>
                                                        <div class="btn-group">

                                                            @if ($item->status == 1)
                                                                <a class="btn-success btn-sm dropdown-toggle"
                                                                    type="button" data-bs-toggle="dropdown"
                                                                    aria-expanded="false">
                                                                    Available
                                                                </a>
                                                            @else
                                                                <a class="btn-danger btn-sm dropdown-toggle"
                                                                    type="button" data-bs-toggle="dropdown"
                                                                    aria-expanded="false">Not
                                                                    Available
                                                                </a>
                                                            @endif
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @if ($item->status == 1)
                                                                    <li>
                                                                        <a class="dropdown-item status-toggle"
                                                                            href="#"

...
@section('hotels')
    <section class="middle-padding">
        <div class="container">
            <form action="{{ route('hotels.update', ['id' => $hotels->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!--dasboard-wrap-->
                    ...
                    <div class="dashboard-content fl-wrap">
                        ...
                        <div class="profile-edit-container">
                            <div class="custom-form">
                                ...
                                <input name="name" type="text" placeholder="Hotel Name"
                                ...
                                <select data-placeholder="City" name="place_type_id" class="chosen-select no-search-select">
                                    ...
                                    @foreach ($placetypes as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $item->id == old('place_type_id', $hotels->place_type_id) ? 'selected' : '' }}>
                                            {{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="profile-edit-container">
                            <div class="custom-form">
                                ...
                                <input name="address" type="text" value="{{ old('address', $hotels->address) }}"
                                ...
                                <div class="listsearch-input-item">
                                    <select data-placeholder="City" name="location_id"
                                        ...
                                        @foreach ($locations as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == old('location_id', $hotels->location_id) ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <label>Phone<i class="far fa-phone"></i> </label>
                                <input name="hotline" type="text" placeholder="Phone"
                                    value="{{ old('hotline', $hotels->hotline) }}" />
                            </div>
                        </div>
                                            ...
                                            <div class="custom-form">
                                                ...
                                                <div class="row d-flex">
                                                    <div class="col-6">
                                                        <label>From</label>
                                                        <input type="time"
                                                            value="{{ old('checkin_time_from', $hotel_timings->checkin_time_from) }}"
                                                            name="checkin_time_from">
                                                    </div>
                                                    <div class="col-6">
                                                        <label>Until</label>
                                                        <input type="time"
                                                            value="{{ old('checkin_time_until', $hotel_timings->checkin_time_until) }}"
                                                            name="checkin_time_until">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="custom-form">
                                                ...
                                                <div class="row d-flex">
                                                    <div class="col-6">
                                                        <label>From</label>
                                                        <input type="time"
                                                            value="{{ old('checkout_time_from', $hotel_timings->checkout_time_from) }}"
                                                            name="checkout_time_from">
                                                    </div>
                                                    <div class="col-6">
                                                        <label>Until</label>
                                                        <input type="time"
                                                            value="{{ old('checkout_time_until', $hotel_timings->checkout_time_until) }}"
                                                            name="checkout_time_until">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="custom-form">
                                                ...
                                                <div class="row d-flex">
                                                    <div class="col-6">
                                                        <label>From</label>
                                                        <input type="time"
                                                            value="{{ old('reception_time_from', $hotel_timings->reception_time_from) }}"
                                                            name="reception_time_from">
                                                    </div>
                                                    <div class="col-6">
                                                        <label>Until</label>
                                                        <input type="time"
                                                            value="{{ old('reception_time_until', $hotel_timings->reception_time_until) }}"
                                                            name="reception_time_until">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                @foreach ($policies as $item)
                                                    <div class="act-widget-header">
                                                        ...
                                                        <div class="onoffswitch">
                                                            <input value="{{ $item->id }}"
                                                                @foreach ($hotel_policies as $i)
                                                                {{ $item->id == old('policy_id', $i->policy_id) ? 'checked' : '' }} @endforeach
                            ...
                            <div class="custom-form">
                                ...
                                <ul class="fl-wrap filter-tags">
                                    @foreach ($facilities as $item)
                                        <li>
                                            <input value="{{ $item->id }}"
                                                @foreach ($hotels_facilities as $i)
                                            {{ $item->id == old('facilities_id', $i->facilities_id) ? 'checked' : '' }} @endforeach
                                                id="check-dd5" type="checkbox" name="facilities[]">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="custom-form">
                                    <label>Text</label>
                                    <textarea name="content" cols="40" rows="3" placeholder="Details">
                                        {{ old('content', $hotels->content) }}
                                    </textarea>
                                </div>
                                <!-- profile-edit-container end-->
                            </div>
